                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center text-secondary">
                    <div className="space-y-6">
                        ...
                        <p className="text-muted-foreground ">
                            I am Developer and I create  modern website,  build interface that are both beautiful and functional .
                        </p>
                        <p className="text-muted-foreground ">
                            I’ve built and maintained a wide range of websites and web apps — from landing pages to backend integration. I pay close attention to detail, focus on accessibility, and continuously learn new tools and trends to stay ahead in the fast-moving world of web development.
                        </p>
                        <div className="flex flex-col sm:flex-row gap-4 pt-4 justify-center">
                            ...
                            <a href={resume} download className="px-6 py-2 rounded-full border border-primary text-primary hover:bg-primary/10 transition-colors duration-300">Download CV</a>
                        </div>
                    </div>
